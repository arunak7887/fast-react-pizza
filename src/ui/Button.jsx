...
export function Button({ children, disabled, to, type }) {
  ...
  const styles = {
    ...
    secondary: `inline-block rounded-full bg-transparent hover:text-stone-800 focus:ring-stone-200  font-semibold uppercase tracking-wide text-stone-800 transition-colors 
